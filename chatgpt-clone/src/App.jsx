    ...
    return (
        ...
        {/* Mobile some nav */}
            <div className="bg-[#202123] flex flex-row md:hidden">
                ...
                <h1 className='text-white mt-2 ml-[30%]'>New Chat</h1>
                <svg className='ml-[32%] mt-2 inline-block icon-sm shrink-0' stroke="#ffffff" fill="#fffff" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
