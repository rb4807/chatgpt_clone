                ...
                <ul className='p-2'>
                    ...
                    <li className='p-2 hover:bg-grays hover:rounded-md hover:p-2' key={item.id}>
                        ...
                        <button className='' onClick={() => handleEdit(item.id)}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="ml-10 md:ml-2 inline-block  justify-end hover:stroke-white icon icon-tabler icon-tabler-pencil-minus" width="18" height="18" viewBox="0 0 24 24" stroke-width="1.5" stroke="#c5c5d2" fill="none" stroke-linecap="round" stroke-linejoin="round">
